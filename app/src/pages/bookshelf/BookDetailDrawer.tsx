...
import { X, Edit3, Trash2, BookOpen, Calendar, Hash, Building2, FileText, Tag, Quote, BookMarked } from 'lucide-react';
                ...
                >
                  ...
                  {book.content && (
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 px-4 py-1.5 bg-[#5B7E71] text-white rounded-[6px] text-[12px] font-medium hover:brightness-105 transition-all cursor-pointer"
                    >
                      <BookMarked size={12} />
                      阅读
                    </button>
